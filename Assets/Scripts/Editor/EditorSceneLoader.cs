...
namespace Celeritas.Editor
{
	...
	public class EditorSceneLoader
	{
		...
		public static void LoadGameScenes()
		{
			...
			EditorSceneManager.OpenScene(Constants.MAIN_SCENE_PATH, OpenSceneMode.Additive);
		}
		...
		{
			EditorSceneManager.OpenScene(Constants.PERSISTENT_SCENE_PATH, OpenSceneMode.Single);
			EditorSceneManager.OpenScene(Constants.RUNSTART_PATH, OpenSceneMode.Additive);
		}
	}
}
